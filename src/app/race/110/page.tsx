...
function index() {
    return (
        <section className=' container'>
            <div>
                <h1 className='font-bold text-2xl text-center'>110 metros Planos</h1>
            </div>
            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg mt-12">
                ...
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 table-auto">
                    ...
                    <tbody>
                        {times.filter(athlete => athlete['110mts']&& athlete.genero === 'M').sort((a, b) => a['110mts'] - b['110mts']).map((athlete, index) => (
            ...
            <h3 className='font-bold '>Femenino</h3>
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
                    ...
                    <tbody>
                        {times.filter(athlete => athlete['110mts'] && athlete.genero === 'F').sort((a, b) => a['110mts'] - b['110mts']).map((athlete, index) => (
                            <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-700">
